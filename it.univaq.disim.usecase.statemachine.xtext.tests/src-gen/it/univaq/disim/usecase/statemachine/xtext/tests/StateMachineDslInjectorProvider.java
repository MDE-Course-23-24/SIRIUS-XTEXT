 ...
 */
package it.univaq.disim.usecase.statemachine.xtext.tests;
...
public class StateMachineDslInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new StateMachineDslStandaloneSetup() {
			@Override
	...
	protected StateMachineDslRuntimeModule createRuntimeModule() {
		// make it work also with Maven/Tycho and OSGI
		// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=493672
		return new StateMachineDslRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return StateMachineDslInjectorProvider.class
						.getClassLoader();
			}
		};
	}
